...
/***/ (function(module, exports, __webpack_require__) {
	...
	function loadContent(src, canvas) {
	  var scroll = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
	...
	var contents = [loadContent('img/air-travel-title.svg', document.querySelector('.Text-title')), loadContent('img/air-travel-title-medium.svg', document.querySelector('.Text-titleMedium'), 0.5), loadContent('img/air-travel-title-small.svg', document.querySelector('.Text-titleSmall'), 0.8)];
